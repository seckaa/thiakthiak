                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body">
                            ...
                            {{-- {{ dd($dataTypeContent->product_attributes) }} --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="product_attributes[{{ $attr->name }}]">
                                        ...
                                        @foreach ($attr->values as $val)
                                            <option
                                                {{ !empty(json_decode($dataTypeContent->product_attributes, true)[$attr->name]) &&
                                                json_decode($dataTypeContent->product_attributes, true)[$attr->name] == $val->value
                                                    ? 'selected'
                                                    : '' }}>
                                                {{ $val->value }}
                                            </option>
