...
<x-main.card>
    ...
    <div
        ...
        <a href="/user/foods/{{ $food->id }}">
            <img class="rounded-t-lg object-cover w-48 h-48 max-w-xs transition duration-300 ease-in-out hover:scale-110"
                data-te-animation-init data-te-animation-start="onScroll" data-te-animation="[fade-in_1s_ease-in-out]"
                src="{{ $food->image ? asset('uploads/' . $food->image) : asset('/images/no-image.png') }}"
                alt="{{ $food->en_name }}" />
        </a>
        <!-- TW Elements is free under AGPL, with commercial license required for specific uses. See more details: https://tw-elements.com/license/ and contact us for queries at tailwind@mdbootstrap.com -->
        <ul class="my-1 flex list-none gap-1 p-0" data-te-rating-init data-te-readonly="true" data-te-value="4.9">
            <li>
                <span class="text-yellow-500 [&>svg]:h-5 [&>svg]:w-5" data-te-rating-icon-ref>
        ...
        <div class="p-6">
            ...
            <a type="button" href="{{ route('cart.add', $food->id) }}"
                class="inline-block rounded bg-laravel px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-accent hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-accent focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-accent-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
