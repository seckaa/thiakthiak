<section>
    ...
    <div data-te-modal-init
        ...
        id="leftBottomModal" tabindex="-1" aria-labelledby="leftBottomModalLabel" aria-hidden="true">
                    ...
                    <form>
                        ...
                        <div class="mb-6 flex min-h-[1.5rem] items-center justify-center pl-[1.5rem]">
                            <input
                                ...
                                type="checkbox" value="" checked id="exampleCheck11" />
                            <label class="inline-block pl-[0.15rem] hover:cursor-pointer" for="exampleCheck11">
